...
class learn():
    ...
    def __init__(self,dataframe, model, target_df, feature_df, fixed_target_df, strategy, sigma,  target_selected_number2, fixedtarget_selected_number2, min_or_max_target, min_or_max_fixedtarget):
    ...
    def updateIndexMEI(self):
        ...
        Expected_Pred_norm=(self.Expected_Pred-np.array(self.target_df.iloc[self.SampIdx].mean(axis=0)))/np.array(self.target_df.iloc[self.SampIdx].std(axis=0))
        #self.scale_data()
